...
var file_patch_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa4, 0x01, 0x0a, 0x05, 0x50, 0x61, 0x74, 0x63, 0x68, 0x12, 0x25,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x39, 0x0a, 0x0a, 0x55, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x46,
	...
	0x12, 0x39, 0x0a, 0x0a, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x50, 0x61, 0x74, 0x63, 0x68, 0x12, 0x12,
	0x2e, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x50, 0x61, 0x74, 0x63, 0x68, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x13, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x50, 0x61, 0x74, 0x63, 0x68, 0x52,
...
var file_patch_service_proto_goTypes = []interface{}{
	...
	(*ApplyPatchRequest)(nil),  // 2: ApplyPatchRequest
	(*PingResponse)(nil),       // 3: PingResponse
	(*UploadFileResponse)(nil), // 4: UploadFileResponse
	(*ApplyPatchResponse)(nil), // 5: ApplyPatchResponse
}
var file_patch_service_proto_depIdxs = []int32{
	0, // 0: Patch.Ping:input_type -> PingRequest
	1, // 1: Patch.UploadFile:input_type -> UploadFileRequest
	2, // 2: Patch.ApplyPatch:input_type -> ApplyPatchRequest
	3, // 3: Patch.Ping:output_type -> PingResponse
	4, // 4: Patch.UploadFile:output_type -> UploadFileResponse
	5, // 5: Patch.ApplyPatch:output_type -> ApplyPatchResponse
