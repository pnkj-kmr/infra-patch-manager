...
func (f *F) IsSameFileAt(d segment.I, old bool) (match bool, err error) {
	if old {
...
func isSameAndNew(f1, f2 segment.I) (match bool) {
...
func isSameAndOld(f1, f2 segment.I) (match bool) {
